...
var companyPublicKey = String(arguments[0]);
var companyName = String(arguments[1]);
var foundingT = String(arguments[2]);
var quorumPublicKey = String(arguments[3]);

/**************************************************************/
const contractAddress = "0xe97289f057b9d88e24d74cf4dc096f9f5ef490bd";
/**************************************************************/
...
CallContract.newCompany.sendTransaction(companyPublicKey, companyName, foundingT, {from:accountOne, gas:3000000}, function(error, result){
