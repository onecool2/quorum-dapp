...
var fromCompanyQuorumPublicKey = String(arguments[0]);
var confidentialCompanyInfoContractAddress = String(arguments[1]);
...
const input = fs.readFileSync('./contract/grantedCompanyInfo.sol');
console.log('Compiling Contract...');
const output = solc.compile(input.toString(), 1);
const bytecode = output.contracts[':grantedCompanyInfo'].bytecode;
const abi = output.contracts[':grantedCompanyInfo'].interface;
//Compile contract
console.log('abi' + ': ' + abi)
...
const companyContractInstance = companyContract.new(
    confidentialCompanyInfoContractAddress,
    {   
        data: '0x' + bytecode,
        from: "0xed9d02e382b34818e88b88a309c7fe71e65f419d",
        gas: 2000000,
        privateFor: ["BULeR8JyUWhiuuCMU/HLA0Q5pzkYT+cHII3ZKBey3Bo=", fromCompanyQuorumPublicKey]
    }, (err, res) => {
        if (err) {
           console.log('Err: ' + err);
           return;
